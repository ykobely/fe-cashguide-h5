...
#后端分支模板所在目录
beRelease = '../yyfq-cash-wap/src/main/webapp/WEB-INF/views'
...
#前端上线发布分支地址
feReleaseGit = 'git@gitlab.szyy.com:fe-release-group/cashguide-h.git'
# feReleaseGit = 'git@gitlab.szyy.com:test-fe-release-group/cashguide-h.git'
...
def releaseQa():
    print 'release to 172.28.3.32 start...'
    ...
    #把vm拷贝到开发或测试环境（联调或测试阶段）
    #cmd = 'rsync -azvP --delete ' + bakTmp + 'WEB-INF/views/page' + ' ' + 'root@172.28.3.124:/home/webapp/tomcat-ymoney-wap/webapps/ROOT/WEB-INF/views'
    #exeCmd(cmd)

    #拷贝静态资源到测试服务器
    #28.32环境
    # cmd = 'scp -r ' + bakTmp + project + ' user_h5@172.28.28.32:/opt/soft/tengine/html/yyfqstatic/'
    ...
    # mljr123
    # cmd = 'scp -r ' + bakTmp + project + ' root@192.168.49.147:/opt/soft/tengine/html/mljr'
    # exeCmd(cmd)
